...
function searchEffect(){
    ...
    window.onscroll= function () {
        ...
        var opacity=0;
        //判断，如果当banner还没有完全滚出屏幕，才有必要计算透明度和设置透明度
...
function bannerEffect(){
    ...
    //webketTransitionEnd:可以监听当前元素的过渡效果执行完毕，当一个元素的过渡效果执行完毕的时候，会触发这个事件
    imgBox.addEventListener("webkitTransitionEnd", function () {
        //如果到了最后一张(count-1),回到索引index=1
